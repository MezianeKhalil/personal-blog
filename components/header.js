        ...
        <>
            <header className={`${home?'py-10 md:py-14 lg:py-16':'py-6 md:py-12 lg:py-14'} font-Poppins  dark:bg-blackTheme`}>
                <div className="container mx-auto px-8 md:px-24 lg:px-44 xl:px-64">
                    <h1 className="capitalize text-gray-900 dark:text-white text-5xl text-center cursor-default">khalil m.</h1>
                    <ul className="flex justify-center">
                        <li className='pl-1'>
                            <a href="https://www.facebook.com/mezianekhalile/" rel="noreferrer" target="_blank" aria-label="facebook account">
                            <svg className="fill-current dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M13.397,20.997v-8.196h2.765l0.411-3.209h-3.176V7.548c0-0.926,0.258-1.56,1.587-1.56h1.684V3.127 C15.849,3.039,15.025,2.997,14.201,3c-2.444,0-4.122,1.492-4.122,4.231v2.355H7.332v3.209h2.753v8.202H13.397z"></path></svg>
                            </a>
                        </li>
                        <li className='pl-1'>
                            <a href="https://twitter.com/khalil_meziane" rel="noreferrer" target="_blank" aria-label="twitter account">
                        ...
                        <li className='pl-1'>
                            <a href="https://github.com/MezianeKhalil" rel="noreferrer" target="_blank" aria-label="github account">
                        ...
                        <li className='pl-1'>
                            <a href="#" target="_blank" rel="noreferrer" aria-label="linkedin account">
                            <svg className="fill-current dark:text-white" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><circle cx="4.983" cy="5.009" r="2.188"></circle><path d="M9.237 8.855v12.139h3.769v-6.003c0-1.584.298-3.118 2.262-3.118 1.937 0 1.961 1.811 1.961 3.218v5.904H21v-6.657c0-3.27-.704-5.783-4.526-5.783-1.835 0-3.065 1.007-3.568 1.96h-.051v-1.66H9.237zM3.095 8.855H6.87V20.994H3.095z"></path></svg>
                            </a>
                        </li>
                    </ul>
                </div>
